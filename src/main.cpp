...
// An IR detector/demodulator is connected to GPIO pin 4(D2 on a NodeMCU
// board).
...
uint8 baseColorIndex = 0;
uint32_t basecolor = BASECOLORS[baseColorIndex];

unsigned long lastBreath = 0.0;
int keyframePointer = 0;
uint32_t breatheLength = 63/3;
